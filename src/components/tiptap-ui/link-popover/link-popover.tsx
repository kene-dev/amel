...
// CUSTOM LINK ICON FROM REACT_ICONS
    ...
    <Popover open={isOpen} onOpenChange={handleOnOpenChange}>
      <PopoverTrigger asChild>
        <LinkButton
         ...
         children={
          <FiLink className={isActive ? 'bg-gray-200 w-12 h-10 p-[10px] rounded-md': 'w-12 h-10 p-[10px] rounded-md'}/>
         }
        />
      </PopoverTrigger>
